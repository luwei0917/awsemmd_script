...
if(args.pulling2):
    ...
    with open('folder_list', 'r') as ins:
        for line in ins:
            ...
            if(args.server):
                if(args.mode == 1):
                    t1 = "/scratch/wl45/freeEnergy_2xov/pullingDistance_v2/" + target + "/simulation/0/halfdata {} {} {}\n".format(temp, kconstant, x)
                    metadata.write(t1)
                elif(args.mode == 2):
                    t2 = "/scratch/wl45/freeEnergy_2xov/pullingDistance_v2/" + target + "/simulation/1/halfdata {} {} {}\n".format(temp, kconstant, x)
                    metadata.write(t2)
            else:
                if(args.mode == 1):
                    t1 = "/Users/weilu/Research/server/freeEnergy_2xov/pullingDistance_v2/" + target + "/simulation/0/halfdata {} {} {}\n".format(temp, kconstant, x)
                    metadata.write(t1)
                elif(args.mode == 2):
                    t2 = "/Users/weilu/Research/server/freeEnergy_2xov/pullingDistance_v2/" + target + "/simulation/1/halfdata {} {} {}\n".format(temp, kconstant, x)
                    metadata.write(t2)
    metadata.close()
