...
biasing_variable_column = 1        # column in the trajectory file that contains the biasing variable information
...
pmf_variable_column_2 = 1          # column in the trajectory file that contians the second pmf variable
...
temperature_increment = 50          # how often (in degrees) to compute the free energy
N_samples = 5000                  # number of correlated samples per simulation
