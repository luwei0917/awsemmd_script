...
/* ----------------------------------------------------------------------
   compute the total z based mass of group of atoms in region
   use either per-type mass or per-atom rmass
------------------------------------------------------------------------- */

double Group::z_based_mass(int igroup, double memb_b, double k_bin)
{
  int groupbit = bitmask[igroup];
...
void Group::z_based_xcm(int igroup, double masstotal, double *cm, double memb_b, double k_bin)
{
  int groupbit = bitmask[igroup];
...
double Group::z_based_cylindricalgyration(int igroup, double masstotal, double *cm, double memb_b, double k_bin)
{
  int groupbit = bitmask[igroup];
  ...
  for (int i = 0; i < nlocal; i++)
    if (mask[i] & groupbit) {
      ...
      massone = massone*theta;


      // Hard code the z dependence.
