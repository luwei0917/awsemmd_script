...
class Group : protected Pointers {
 public:
  ...
  double mass(int,int);
  double z_based_mass(int, double, double);                        // total mass of atoms in group
  ...
  void z_based_xcm(int, double, double *, double, double); // z dependent center-of-mass coords of group
  ...
  double z_based_cylindricalgyration(int, double, double *, double, double);  // cylindrical radius-of-gyration of group
