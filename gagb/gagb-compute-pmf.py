...
energy_column = 7                  # column in the trajectory file that contains the total (unbiased) potential energy
...
N_samples = 4000                   # number of correlated samples per simulation
