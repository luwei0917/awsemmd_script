...
os.system("cp ~/opt/AAWSEM/project_AAWSEM/aasem/_data/"+protein_name+" ssweight")
os.system("cp ~/opt/AAWSEM/project_AAWSEM/fragmem/HO_Mem/"+protein_name+"/frag.mem frag.mem_old")
