...
submit_to_cluster = False          # flag for submitting calculation to a cluster (eliminates interactivity)
precision_threshold = 10e-13       # threshold to determine whether or not to attempt to compute expectation values
subsample_trajectories = True      # flag for using pymbar's built-in subsampling features
...
metadata_file = 'metadata'         # name of the metadata file
biasing_variable_column = 2        # column in the trajectory file that contains the biasing variable information
energy_column = 6                  # column in the trajectory file that contains the total (unbiased) potential energy
pmf_variable_column_1 = 2          # column in the trajectory file that contains the first pmf variable
pmf_variable_column_2 = 3          # column in the trajectory file that contians the second pmf variable
nbins1 = 20                        # number of bins for the first pmf variable
...
end_temperature = 500              # temperature at which to stop the free energy calculations
temperature_increment = 1          # how often (in degrees) to compute the free energy
N_samples = 10000                  # number of correlated samples per simulation
