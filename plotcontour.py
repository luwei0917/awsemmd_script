...
parser.add_argument("-ymin", default=10, type=float, help="y axis lower limit")
parser.add_argument("-ymax", default=15, type=float, help="y axis upper limit")
...
parser.add_argument("-zmax", default=25, type=float, help="z axis upper limit")
