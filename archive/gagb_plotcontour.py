...
parser.add_argument("-zmax", default=20, type=float, help="z axis upper limit")
parser.add_argument("-title", default='', help="title")
parser.add_argument("-xlabel", default='Qo of GB', help="xlabel")
parser.add_argument("-ylabel", default='Qo of GA', help="ylabel")
...
# mycmap = Dark2_7.mpl_colors
# print(jet)
# plt.contourf(xi, yi, zi, 20, cmap=mycmap)
# plt.contourf(xi, yi, zi, 10, cmap="terrain")
plt.contourf(xi, yi, zi, 10, cmap="jet")
plt.xlim(args.xmin, args.xmax)
plt.ylim(args.ymin, args.ymax)
# plt.clim(args.zmin, 4)
